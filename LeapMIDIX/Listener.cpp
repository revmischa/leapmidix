...
namespace LeapMIDIX {
    ...
    void Listener::onControlUpdated(const Leap::Controller &controller, GestureBasePtr gesture, ControlBasePtr control) {
        ...
        // instead of assuming control signal,
        // let's instead look at the type of gesture and our
        // program should have a mapping. to say something like
        // "hand curvature < 50 should trigger midi note on"
